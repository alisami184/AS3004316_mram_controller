...
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[16] }]; #IO_L16N_T2_A27_15 Sch=fmc_la_n[02]
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[17] }]; #IO_L16P_T2_A28_15 Sch=fmc_la_p[02]
set_property -dict { PACKAGE_PIN N19   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[11] }]; #IO_L17N_T2_A25_15 Sch=fmc_la_n[03]
set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[10] }]; #IO_L17P_T2_A26_15 Sch=fmc_la_p[03]
set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS12 } [get_ports { g }]; #IO_L18N_T2_A23_15 Sch=fmc_la_n[04]
set_property -dict { PACKAGE_PIN N20   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[15] }]; #IO_L18P_T2_A24_15 Sch=fmc_la_p[04]
...
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS12 } [get_ports { lb }]; #IO_L20N_T3_A19_15 Sch=fmc_la_n[07]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS12 } [get_ports { ub }]; #IO_L20P_T3_A20_15 Sch=fmc_la_p[07]
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[13] }]; #IO_L24N_T3_RS0_15 Sch=fmc_la_n[08]
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[12] }]; #IO_L24P_T3_RS1_15 Sch=fmc_la_p[08]
...
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS12 } [get_ports { dq[14] }]; #IO_L22N_T3_A16_15 Sch=fmc_la_n[11]
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS12 } [get_ports { dq[15] }]; #IO_L22P_T3_A17_15 Sch=fmc_la_p[11]
set_property -dict { PACKAGE_PIN L20   IOSTANDARD LVCMOS12 } [get_ports { dq[8] }]; #IO_L14N_T2_SRCC_15 Sch=fmc_la_n[12]
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[14] }]; #IO_L14P_T2_SRCC_15 Sch=fmc_la_p[12]
...
set_property -dict { PACKAGE_PIN H22   IOSTANDARD LVCMOS12 } [get_ports { clk_out }]; #IO_L7N_T1_AD2N_15 Sch=fmc_la_n[14]
set_property -dict { PACKAGE_PIN J22   IOSTANDARD LVCMOS12 } [get_ports { fmc_la_p[14] }]; #IO_L7P_T1_AD2P_15 Sch=fmc_la_p[14]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS12 } [get_ports { dq[13] }]; #IO_L23N_T3_FWE_B_15 Sch=fmc_la_n[15]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS12 } [get_ports { dq[12] }]; #IO_L23P_T3_FOE_B_15 Sch=fmc_la_p[15]
set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS12 } [get_ports { dq[11] }]; #IO_L4N_T0_15 Sch=fmc_la_n[16]
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS12 } [get_ports { dq[9] }]; #IO_L4P_T0_15 Sch=fmc_la_p[16]
...
set_property -dict { PACKAGE_PIN A19   IOSTANDARD LVCMOS12 } [get_ports { dq[0] }]; #IO_L17N_T2_16 Sch=fmc_la_n[19]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS12 } [get_ports { dq[3] }]; #IO_L17P_T2_16 Sch=fmc_la_p[19]
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS12 } [get_ports { dq[7] }]; #IO_L18N_T2_16 Sch=fmc_la_n[20]
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS12 } [get_ports { dq[10] }]; #IO_L18P_T2_16 Sch=fmc_la_p[20]
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS12 } [get_ports { dq[2] }]; #IO_L14N_T2_SRCC_16 Sch=fmc_la_n[21]
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS12 } [get_ports { dq[1] }]; #IO_L14P_T2_SRCC_16 Sch=fmc_la_p[21]
set_property -dict { PACKAGE_PIN D21   IOSTANDARD LVCMOS12 } [get_ports { dq[5] }]; #IO_L23N_T3_16 Sch=fmc_la_n[22]
set_property -dict { PACKAGE_PIN E21   IOSTANDARD LVCMOS12 } [get_ports { dq[6] }]; #IO_L23P_T3_16 Sch=fmc_la_p[22]
...
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[4] }]; #IO_L7N_T1_16 Sch=fmc_la_n[24]
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS12 } [get_ports { e }]; #IO_L7P_T1_16 Sch=fmc_la_p[24]
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS12 } [get_ports { w }]; #IO_L2N_T0_16 Sch=fmc_la_n[25]
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS12 } [get_ports { dq[4] }]; #IO_L2P_T0_16 Sch=fmc_la_p[25]
...
set_property -dict { PACKAGE_PIN B13   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[2] }]; #IO_L8N_T1_16 Sch=fmc_la_n[28]
set_property -dict { PACKAGE_PIN C13   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[3] }]; #IO_L8P_T1_16 Sch=fmc_la_p[28]
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[6] }]; #IO_L3N_T0_DQS_16 Sch=fmc_la_n[29]
set_property -dict { PACKAGE_PIN C14   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[5] }]; #IO_L3P_T0_DQS_16 Sch=fmc_la_p[29]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[0] }]; #IO_L10N_T1_16 Sch=fmc_la_n[30]
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[1] }]; #IO_L10P_T1_16 Sch=fmc_la_p[30]
set_property -dict { PACKAGE_PIN E14   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[8] }]; #IO_L4N_T0_16 Sch=fmc_la_n[31]
set_property -dict { PACKAGE_PIN E13   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[7] }]; #IO_L4P_T0_16 Sch=fmc_la_p[31]
...
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS12 } [get_ports { mram_addr[9] }]; #IO_L1P_T0_16 Sch=fmc_la_p[33]
